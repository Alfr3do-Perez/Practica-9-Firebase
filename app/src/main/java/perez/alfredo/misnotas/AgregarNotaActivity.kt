package perez.alfredo.misnotas
...
class AgregarNotaActivity : AppCompatActivity() {
    ...
    public fun guardar(){
        ...
        if(titulo == "" || contenido == ""){Toast.makeText(this, "No puede haber campos vacios!", Toast.LENGTH_SHORT).show()}
        else{
            try{
            ...
            }catch (e:Exception){Toast.makeText(this, "Error: No se pudo guardar el archivo!", Toast.LENGTH_SHORT).show()}
        }
        finish();
    }
